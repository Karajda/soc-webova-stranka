...
def vypocet(typ_limitu, hodnota_limitu):    #Výpočet Eulerova čísla pomocí definice limitou
    ...
    jedna = mpf(1)  #Převedení čísla 1 na přesnost nastavenou výše, aby nedocházelo ke konverzi datových typů každou iteraci
    ...
    while True:
        ...
        e = (jedna + jedna/krok)**krok  #Výpočet jedné iterace
