...
def vypocet(typ_limitu, hodnota_limitu):    #Výpočet čísla pí pomocí Vièteho metody
    ...
    clen = mpf(0)   #Průběžný člen Vièteho řady
    dva = mpf(2)    #Převedení čísla 2 na přesnost nastavenou výše, aby nedocházelo ke konverzi datových typů každou iteraci
