...
def vypocet(typ_limitu, hodnota_limitu):    #Výpočet zlatého řezu pomocí řetězového zlomku
    ...
    while True:
        ...
        citatel = pred_citatel + pred_pred_citatel
        jmenovatel = pred_jmenovatel + pred_pred_jmenovatel
        fi = citatel / jmenovatel
